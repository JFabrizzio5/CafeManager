...
<body>
    ...
    <div class="TextProducto">
        <b>
            Ricos y deliciosos pastes saldos y dulces
        </b>
    </div>
    ...
    <div class="ImageProducto">
        <img src="assets/images/Pastes.jpg" style="position: absolute; top: 40px; left: 40px; width: 350px; height: 300px;" />
    </div>
</body>
</html>