...
<body>
    ...
    <div class="TextProducto">
        <b>
            Hamburguesa sabrosas de varios tipos
        </b>
    </div>
    ...
    <div class="ImageProducto">
        <img src="assets/images/hamburguesa.jpg" style="position: absolute; top: 40px; left: 40px; width: 350px; height: 300px;" />
    </div>
</body>
</html>